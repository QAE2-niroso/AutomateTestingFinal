...
Mobile.setText(findTestObject('Mobile/Login/inputEmail'), 'yoshua@gmail.com', 0)
Mobile.takeScreenshotAsCheckpoint('1. isi field email')

Mobile.clearText(findTestObject('Mobile/Login/inputPassword'), 0, FailureHandling.STOP_ON_FAILURE)
