...
WebUI.setText(findTestObject('Web/EditProfile/input_Phone_whatsapp'), '089563145')
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-007/1.png')

WebUI.click(findTestObject('Web/EditProfile/button_Save Changes'))
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-007/2.png')

WebUI.verifyTextPresent('The whatsapp must be between 10 and 12 digits.', false)
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-007/3.png')
