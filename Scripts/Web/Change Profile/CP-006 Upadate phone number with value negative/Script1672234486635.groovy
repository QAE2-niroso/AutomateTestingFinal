...
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-006/1.png')

WebUI.click(findTestObject('Web/EditProfile/button_Save Changes'))
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-006/2.png')

//Harusnya message error selainn ini =
WebUI.verifyTextPresent('The whatsapp must be between 10 and 12 digits.', false)
WebUI.takeScreenshot('Screenshots/Web/ChangeProfile/CP-006/3.png')
