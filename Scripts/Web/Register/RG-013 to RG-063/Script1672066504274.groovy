...
for(int i = 1;i<=51;i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Web/Register/Input_register/Page_Buat akun dan dapatkan akses di Coding.ID/input_birth_date'),
		findTestData("Raw Data/Web/Register/RegData").getValue(4,i)+'-'+findTestData("Raw Data/Web/Register/RegData").getValue(3,i)+'-'+findTestData("Raw Data/Web/Register/RegData").getValue(2,i))
	...
	WebUI.setEncryptedText(findTestObject('Object Repository/Web/Register/Input_register/Page_Buat akun dan dapatkan akses di Coding.ID/input_Kata Sandi_password'),
		findTestData("Raw Data/Web/Register/RegData").getValue(7,i))
	
	WebUI.setEncryptedText(findTestObject('Object Repository/Web/Register/Input_register/Page_Buat akun dan dapatkan akses di Coding.ID/input_confirmation'),
	...
	WebUI.takeScreenshot('Screenshots/Web/Register/rg13/rg-13+'+i, FailureHandling.STOP_ON_FAILURE)
